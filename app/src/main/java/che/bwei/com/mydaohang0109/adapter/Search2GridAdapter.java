 ...
 */
public class Search2GridAdapter extends RecyclerView.Adapter<Search2GridAdapter.SearchViewHolder>{

    List<SearchBean.DataBean> listDa;
    Context context;
    public Search2GridAdapter(Context context) {
    ...
    public SearchViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.search2grid_item,null);
